...
public class OrderConsumer {
    ...
    public void consumeOrder(
        ...
        log.info("Received order from order-service: orderId={}, topic={}, partition={}, offset={}",
    ...
    void processOrder(Order order) {
        log.info("Processing order into notification: {}", order.getOrderId());
        var notification = orderProcessingService.buildNotification(order);
